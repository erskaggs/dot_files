...
describe "AnsibleGalaxy", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('ansible-galaxy')

  describe "when the ansible-galaxy:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'ansible-galaxy:toggle'
        expect(ansibleGalaxyPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'ansible-galaxy:toggle'
        expect(ansibleGalaxyElement).not.toBeVisible()
